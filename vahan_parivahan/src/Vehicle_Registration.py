...
#                            //*[@id="datatable_rtoWise:0:j_idt136:1:j_idt138"]
                        ...
                        for CategoryWise_data_index in range(len(CategoryWise_data)):
                            ...
                            try:
                                classwise_data=pd.read_excel(r"C:\Users\uday.gupta\Desktop\Parivahan\CategoryWise.xls")
                            except:
                                classwise_data=pd.read_excel(r"D:\Hdfc_Scrapping_data\Uday\Scrapping_data\vahan_parivahan\Vehgical_registration\CategoryWise.xls")
                            dt1={}
                            for classwise_data_index in range(len(classwise_data)):
                                #link for the      classwise_data_index=0
                                dt1={'Period':Period,'State':state_name,
                                    ...
                                    'Vehicle_Class':classwise_data[' Vehicle Category '][classwise_data_index],
