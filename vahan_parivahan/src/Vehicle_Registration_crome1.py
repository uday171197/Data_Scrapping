...
def Click_Rtos(x,wait):
    count1_term  = 0
    Click =True
    while Click ==True and count1_term < 16:
        try:
...
#                            table_main_data =table_main_data.dropna()
                ...
                for st_in in tqdm(range(int(states_index),len(download_st))):
                    # st_in = 0
                    ...
                    print('Downloaded rto file of {}'.format(state_name))
                    time.sleep(3)
                    try:
                    ...
                    for rto_data_index in range(int(rto_index),len(rto_data)):
                        ...
                        print('No of RTO : {}'.format(rto_data_index))
#                            //*[@id="datatable_rtoWise:0:j_idt136:1:j_idt138"]
                        ...
                        for CategoryWise_data_index in range(len(CategoryWise_data)):
                            ...
                            try:
                                ...
                                try:
                                    wait.until(EC.element_to_be_clickable((By.XPATH,'//*[@id="datatableCategoryWise_paginator_bottom"]/a[3]'))).click()
                                    time.sleep(1)
                                    element1=wait.until(EC.element_to_be_clickable((By.XPATH,y))).click()
                                    time.sleep(2)
                                except:
